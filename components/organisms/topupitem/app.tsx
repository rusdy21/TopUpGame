...
interface PropsTopUpItem {
    type: 'desktop' | 'mobile'
}

export default function TopUpItem(props: PropsTopUpItem) {
    const {type} = props;
    if (type === 'desktop') {
        return (
            <div className="pb-50 d-md-block d-none">
                        <h2 className="text-4xl fw-bold color-palette-1 text-start mb-10 mt-10">Mobile Legends:<b/>
